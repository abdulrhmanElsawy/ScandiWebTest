...
<nav class="land-nav">
    ...
    <div class="btns">
        ...
        <button  type='submit' value='Delete' name='but_delete' id="delete-product-btn">MASS DELETE</button>
    </div>
</nav>
...
<section class="products">
    <div class="row">
        ...
        <?php
            $getItems= $con->prepare('SELECT * FROM products');
            ...
            if ($Items) {
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                    ...
                    <input name="ids[]" value="'.  $Item['id']  .'" type="checkbox" class="delete-checkbox">
                        <h2>'. $Item['sku'] .'</h2>
                        <h2>'. $Item['name'] .'</h2>
                        <h2>'. $Item['price'] .'$</h2>
                        ';
